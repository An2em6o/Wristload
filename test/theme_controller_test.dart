...
import 'package:wristload/presentation/app_theme.dart';
...
void main() {
  ...
  test('Tianyi Blue remains bright in dark mode', () {
    final theme = buildWristloadTheme(
      seedColor: ThemeController.tianyiBlue,
      brightness: Brightness.dark,
    );

    expect(theme.colorScheme.primary, ThemeController.tianyiBlue);
    expect(theme.colorScheme.onPrimary, Colors.black);
  });

  testWidgets(
    'theme preview keeps visible progress segments in light and dark themes',
    (tester) async {
